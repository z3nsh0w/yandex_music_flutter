...
Future<void> showAccountInfo() async {
  ...
  try {
    ...
    String userEmail = await yandexMusic.account.getUserEmail();
...
Future<void> showTracks() async {
  ...
  try {
    List likedTracks = await yandexMusic.usertracks.getUsersLikedTracks();
    List dislikedTracks = await yandexMusic.usertracks.getUsersDislikedTracks();
